...
if [ "$DRY_RUN" = 1 ]; then
  ...
  KEYS="DATABASE_URL SUPABASE_URL SUPABASE_ANON_KEY SUPABASE_SERVICE_ROLE_KEY \
SUPABASE_SCHEMA OPENAI_API_KEY OPENAI_ORG_ID OPENAI_MODEL OPENAI_REASONING_EFFORT \
MONTHLY_CAP_USD TG_BOT_TOKEN TG_WEBHOOK_SECRET TG_ALLOWED_CHAT_IDS POST_TOKEN \
SCHEDULER_ENABLED TIMEZONE"
  {
